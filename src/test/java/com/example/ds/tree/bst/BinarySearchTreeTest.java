...
import com.example.ds.tree.BinaryTreeTestHelper;
import com.example.ds.tree.TraversalOrder;
...
public class BinarySearchTreeTest {
    ...
    @Test
    public void shouldSelfBalance_OnInsert() {
        BinarySearchTree<Integer> binarySearchTree = new BinarySearchTree<>();
        ...
        // insert from an ordered array
        // which would result in highly an unbalanced tree
        Integer[] bstItems = { 0, 1, 2, 3, 4, 5, 6 };
    ...
    @Test
    public void shouldSelfBalance_OnRemove() {
        BinarySearchTree<Integer> binarySearchTree = new BinarySearchTree<>();
        ...
        // let's remove from one subtree untill imbalanced
        Assert.assertEquals(0, binarySearchTree.remove(0).intValue());
        Assert.assertEquals(1, binarySearchTree.remove(1).intValue());
        Assert.assertEquals(2, binarySearchTree.remove(2).intValue());

        Iterator<TreeNode<Integer>> iterator = binarySearchTree.getNodesLevelOrder().iterator();
        ...
        // testScenarios.put(TraversalOrder.LEVEL_ORDER, new Integer[] { 3, 1, 5, 0, 2,
        // 4, 6 });
        // testScenarios.put(TraversalOrder.REVERSE_LEVEL_ORDER, new Integer[] { 3, 5,
        // 1, 6, 4, 2, 0 });
        // testScenarios.put(TraversalOrder.IN_ORDER, new Integer[] { 0, 1, 2, 3, 4, 5,
        // 6 });
        // testScenarios.put(TraversalOrder.REVERSE_IN_ORDER, new Integer[] { 6, 5, 4,
        // 3, 2, 1, 0 });
        // testScenarios.put(TraversalOrder.PRE_ORDER, new Integer[] { 3, 1, 0, 2, 5, 4,
        // 6 });
        // testScenarios.put(TraversalOrder.REVERSE_PRE_ORDER, new Integer[] { 3, 5, 6,
        // 4, 1, 2, 0 });
        // testScenarios.put(TraversalOrder.POST_ORDER, new Integer[] { 0, 2, 1, 4, 6,
        // 5, 3 });
        // testScenarios.put(TraversalOrder.REVERSE_POST_ORDER, new Integer[] { 6, 4, 5,
        // 2, 0, 1, 3 });
